...
class DummyData {
  static final List<LocationItem> nouakchottLocations = [
    LocationItem(
      name: 'سوق العاصمة',
      description: 'وسط المدينة، نواكشوط',
      lat: 18.0878,
      lng: -15.9789,
    ),
    LocationItem(
      name: 'المطار الدولي (أم التونسي)',
      description: 'طريق نواذيبو، نواكشوط',
      lat: 18.3117,
      lng: -15.9678,
    ),
    LocationItem(
      name: 'مجمع البيت',
      description: 'تفرغ زينة، نواكشوط',
      lat: 18.1025,
      lng: -15.9754,
    ),
    LocationItem(
      name: 'تفرغ زينة',
      description: 'الحي السكني الراقي، نواكشوط',
      lat: 18.1065,
      lng: -15.9664,
    ),
    LocationItem(
      name: 'لكصر',
      description: 'المقاطعة القديمة، نواكشوط',
      lat: 18.0982,
      lng: -15.9592,
    ),
    LocationItem(
      name: 'عرفات',
      description: 'المنطقة الجنوبية، نواكشوط',
      lat: 18.0435,
      lng: -15.9521,
    ),
    LocationItem(
      name: 'تيارت',
      description: 'المنطقة الشمالية، نواكشوط',
      lat: 18.1255,
      lng: -15.9288,
    ),
    LocationItem(
      name: 'الرياض',
      description: 'طريق روصو، نواكشوط',
      lat: 18.0125,
      lng: -15.9688,
    ),
    LocationItem(
      name: 'دار النعيم',
      description: 'شمال شرق المدينة، نواكشوط',
      lat: 18.1098,
      lng: -15.9087,
    ),
  ];

...
/// screen carrying the amount and the bank's own message so the customer
/// sees exactly what happened. Mirrors the captain app's own
/// BpaySuccessScreen (aihoudhoud repo). Success flow ends with a "back"
/// button that pops all the way out of the recharge flow.
class BpayResultScreen extends StatelessWidget {
  final double amount;
  final BpayRechargeStatus status;
  final String bankMessage;

  const BpayResultScreen({
    super.key,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Amount block - shown for every outcome so the customer
